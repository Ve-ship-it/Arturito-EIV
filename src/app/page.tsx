...
// ─── Mini Modal (igual al de videos/page.tsx) ─────────────────────────────────
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          <span className="text-accent text-[10px] font-bold uppercase tracking-widest">{video.category}</span>
          ...
          <div className="flex items-center gap-4 mt-4 text-white/40 text-xs">
            <span className="flex items-center gap-1"><Eye size={12} /> {video.views} visualizaciones</span>
...
export default function Home() {
  ...
  // Prioridad: Vlog → Competencia → Entrevistas → cualquier último video
  const featuredVideo =
