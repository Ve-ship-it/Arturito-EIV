...
export default function TeamPage() {
  return (
    <div className="pt-24">
      ...
      {/* Competitors Section */}
      <section id="competidores" className="py-24 bg-primary text-white">
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="text-center mb-16">
            ...
            <p className="text-white/70">Conoce a los equipos contra los que nos medimos en la pista.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {['Team Phoenix', 'CyberKings', 'RoboMasters XR'].map((comp) => (
              <Card key={comp} className="bg-white/5 border-white/10 text-white overflow-hidden group hover:bg-accent/10 transition-colors">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-xl font-bold mb-2">{comp}</h3>
                  <p className="text-white/50 text-sm mb-6">Expertos en robótica de combate y drones autónomos.</p>
                  <Button variant="link" className="text-accent gap-2 p-0">Ver Perfil <ExternalLink size={14} /></Button>
                </CardContent>
              </Card>
            ))}
          </div>
