...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    content:
      "El sábado 8 de noviembre, nuestro equipo de robótica R2D2 EIV vivió una jornada inolvidable durante la Competencia Regional First Lego League (FLL) 2025, realizada en el colegio Pumahue de Curauma, donde equipos escolares de la región demostraron su creatividad, conocimientos y habilidades técnicas. Los estudiantes del ACLE nos llenaron de orgullo al conseguir el primer lugar en Proyecto de Innovación, destacando su capacidad para diseñar una solución creativa frente a un problema real, y el segundo lugar regional, logro que les permitirá representar a nuestro establecimiento en la competencia nacional en el Colegio Alemán de Santiago. Estos resultados reflejan el esfuerzo del equipo, el apoyo de sus docentes y el compromiso de la EIV con el desarrollo de la educación científica y tecnológica dentro de la Educación Técnico-Profesional.",
    date: "19 Nov 2025",
    category: "Competencia",
  ...
  },
  {
    ...
    content:
      "El pasado 7 de diciembre celebramos un hito que marcará el futuro de nuestros estudiantes y de la educación tecnológica en el país. El equipo R2D2 EIV se coronó campeón nacional en la final de la First Lego League 2024, un certamen de renombre internacional que impulsa la creatividad, el trabajo en equipo y la innovación tecnológica entre los jóvenes. Tras una destacada participación, los talentosos estudiantes no solo lograron el primer lugar en la categoría de juego del robot, sino que al coronarse como Campeones Nacionales, aseguraron su pase para competir en el First Championship en Houston, Texas, en abril de 2025, representando a Chile ante equipos de todo el mundo.",
    date: "09 Dic 2024",
    category: "Competencia",
